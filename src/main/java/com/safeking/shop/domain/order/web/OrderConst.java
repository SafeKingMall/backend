...
public class OrderConst {
    ...
    public static final String ADMIN_ORDER_DETAIL_MODIFY_SUCCESS = "관리자용 주문 상세 조회 성공";
    public static final String ADMIN_ORDER_DETAIL_MODIFY_FAIL = "관리자용 주문 상세 조회 실패";
    public static final String ADMIN_ORDER_LIST_FIND_SUCCESS = "주문 다건 조회 성공";
    public static final String ADMIN_ORDER_LIST_FIND_FAIL = "주문 상세 조회 실패";
}
